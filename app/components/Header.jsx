    ...
    <header className="sticky top-0 z-20 border-b border-white/20 bg-white/60 backdrop-blur-md dark:border-white/10 dark:bg-slate-950/40">
      <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-brand-600 via-brand-500 to-cyan-400 text-white font-bold drop-shadow-neon">W</span>
          <span className="text-lg font-semibold tracking-tight text-glow">Ways of Working Articles</span>
        </Link>
